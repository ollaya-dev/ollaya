...
1. Disable feature flag (if applicable)
   OR
1. Deploy previous version: `git revert <commit>`
...
- For the project-wide Definition of Done that every change must clear before this checklist, see `../_references/definition-of-done.md`
- For security pre-launch checks, see `../_references/security-checklist.md`
- For performance pre-launch checklist, see `../_references/performance-checklist.md`
- For accessibility verification before launch, see `../_references/accessibility-checklist.md`
