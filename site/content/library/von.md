...
- **Parity.** Ollaya's Rust runtime reproduces the Python reference: the same token ids and option markers, and the same decision on every test question, on CPU and CUDA.
